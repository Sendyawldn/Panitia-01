        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              Kami panitia telah menyusun berbagai rangkaian acara dan perlombaan yang dirancang untuk semua kalangan, dari anak-anak hingga dewasa. Mari berpartisipasi dan jadikan perayaan ini tak terlupakan!
            </p>
            
            <div className="flex gap-4">
              <div className="border-l-4 border-indo-red pl-4">
                <p className="text-3xl font-bebas text-slate-900">15+</p>
                <p className="text-slate-500 font-medium">Perlombaan</p>
              </div>
              <div className="border-l-4 border-indo-red pl-4 ml-4">
                <p className="text-3xl font-bebas text-slate-900">500+</p>
          ...
          <div className="grid grid-cols-2 gap-4 relative">
            ...
            >
              <div className="h-48 rounded-3xl overflow-hidden shadow-lg bg-gray-200 relative">
                <img src="https://images.unsplash.com/photo-1541845157-a53f683a54d4?q=80&w=800&auto=format&fit=crop" alt="Perayaan" className="w-full h-full object-cover" />
              </div>
              <div className="h-64 rounded-3xl overflow-hidden shadow-lg bg-indo-red relative flex items-center justify-center p-6 text-center">
                <p className="font-bebas text-3xl text-white">Semangat<br/>Gotong Royong</p>
              </div>
            </motion.div>
            ...
            >
              <div className="h-64 rounded-3xl overflow-hidden shadow-lg bg-gray-200 relative">
                <img src="https://images.unsplash.com/photo-1531206715517-5c0ba140b2b8?q=80&w=800&auto=format&fit=crop" alt="Lomba" className="w-full h-full object-cover" />
              </div>
              <div className="h-48 rounded-3xl overflow-hidden shadow-lg bg-gray-200 relative">
                <img src="https://images.unsplash.com/photo-1511632765486-a01c80cb8fa4?q=80&w=800&auto=format&fit=crop" alt="Kebersamaan" className="w-full h-full object-cover" />
              </div>
            </motion.div>
          </div>
