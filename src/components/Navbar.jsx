...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className={`max-w-7xl mx-auto rounded-2xl transition-all duration-300 flex items-center justify-between px-6 py-3
        ...
        >
          {mobileMenuOpen ? <X size={24} /> : <Menu size={24} className={!isScrolled ? 'text-slate-800 sm:text-white' : ''} />}
        </button>
      </div>
