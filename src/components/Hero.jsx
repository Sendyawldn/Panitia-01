    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-20 pt-12 pb-24">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          >
            Senin, 17 Agustus 2026 di Lapangan Bulu Tangkis RT 01/RW 19, Kp.
            Kedep, Desa Tlajung Udik, Gunungputri.
          </motion.p>
          ...
          >
            <div className="flex items-center gap-3 text-white">
              ...
              <div className="text-left">
                ...
                <p className="font-semibold">17 Agustus 2026</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-white">
              ...
              <div className="text-left">
                ...
                <p className="font-semibold text-sm">
                  Lapangan Bulu Tangkis RT 01/RW 19
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20 translate-y-1">
        <svg
          ...
          className="w-full h-auto fill-indo-white"
        >
